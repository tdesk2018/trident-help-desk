...
@Component({
  selector: 'app-sidebarsupporter',
  templateUrl: './sidebar_supporter.component.html',
  styleUrls: ['./sidebar_supporter.component.scss']
})




export class SidebarSupporterComponent implements OnInit {
